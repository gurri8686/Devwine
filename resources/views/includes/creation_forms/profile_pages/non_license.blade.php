<div class="tab-inner-bg">
     <h1 class="main-heading-H1">Non License Vendor Profile</h1>
     ...
     <div class="short-box-main">
      ...
      <div class="bussion-detail">
         <br>
      <h4 class="form-heading">Non License Type</h4>
      <div class="bussion-detail-bx">
       <ul class="vernder-address">
          <!--  -->
           <li><span>Non License Type:</span><?php echo $value->accomodation_sub_type;?></li>
