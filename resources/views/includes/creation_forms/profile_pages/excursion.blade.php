...
<div class="tab-inner-bg">
     <h1 class="main-heading-H1">Excursion Vendor Profile</h1>
     <ul class="prev-next-btns">
       ...
       <li style="text-align: left;">
        ...
        <li style="text-align: right;">
            <button type="button" class="prev"><a href='/vendor?id=<?php echo $next_id; ?>&filter=<?php echo $filter;?>&sort=<?php echo $sort;?>&keyword=<?php echo $keyword;?>&total=<?php echo $total;?>'>Next</a><span>>></span></button>
        </li>
        <?php 
        } 
        ?>
     ...
     <div class="short-box-main">
      ...
      <div class="bussion-detail">
         <br>
      <h4 class="form-heading">Excursion Type</h4>
      <div class="bussion-detail-bx">
       <ul class="vernder-address">
           <li><span>Excursion Type:</span><?php echo $value->accomodation_sub_type; ?></li>
           <li><span>Experience Type:</span><?php echo $value->experience_type; ?></li>
