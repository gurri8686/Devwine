<div class="row accomodation_vendor">
   <h2 class="main-heading-H1">Licensed Vendor Creation Form</h2>
   ...
   <form method="" id="license_form" class="row">
      ...
      <div class="form-group col-md-6">
         ...
         <input type="text" class="form-control" id="" name="license_buisness_vendor_name" aria-describedby="" required="">
      </div>
       <div class="col-md-6"></div>
      <div class="form-group col-md-6">
         <label for="" class="form-label">Street Address<span>*</span></label>
         <input type="text" class="form-control" id="" name="license_street_address" required="">
      </div>
      <div class="form-group col-md-6">
         <label for="" class="form-label">Unit/Suite#</label>
         <input type="text" class="form-control" id="" name="license_unit">
      </div>
      ...
      <div class="form-group col-md-6">
         ...
         <input type="text" class="form-control" id="" name="license_vendor_city" required="">
      </div>
      <div class="form-group col-md-6">
      <label for="" class="form-label">Province/State<span>*</span></label>
      <input type="text" class="form-control" id="" name="license_state" required="">
      </div>
      <div class="form-group col-md-6">
      <label for="" class="form-label">Postal / Zip<span>*</span> </label>
      <input type="text" class="form-control" id="" name="license_vendor_postal" required="">
   </div>
      <div class="form-group col-md-6">
         <label for="" class="form-label">Country<span>*</span> </label>
         <input type="text" class="form-control" id="" name="license_vendor_country" required="">
      </div>
      <h4 class="form-heading">Sub-Region<span>*</span></h4>
      <div class="ul-list">
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_region" id="exampleCheck1" value="Niagara Falls">
                              <label>Niagara Falls</label>
                           </div>
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_region" id="exampleCheck1" value="Niagara-on-the-Lake">
                              <label>Niagara-on-the-Lake</label>
                           </div>
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_region" id="exampleCheck1" value="Niagara Escarpment/ Twenty Valley">
                              <label>Niagara Escarpment/ Twenty Valley</label>
                           </div>
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_region" id="exampleCheck1" value="Fort Erie/ Niagara South Coast">
                              <label>Fort Erie/ Niagara South Coast</label>
                           </div>
                           </div>
      <div class="mb-3">
         <label for="" class="form-label">Business/Vendor Phone: </label>
         <input type="text" class="form-control" id="" name="license_vendor_phone" required="">
      </div>
      ...
      <h2 class="form-heading">Licensee Details</h2>
      <h5 class="form-sub-heading">Licensee Sub-Type: <span>*</span></h5>
      <div class="" name="excursion_acc_sub_type">
     <div class="ul-list">
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_type" id="exampleCheck1" value="Restaurant">
                              <label>Restaurant</label>
                           </div>
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_type" id="exampleCheck1" value="Bar / Pub">
                              <label>Bar / Pub</label>
                           </div>
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_type" id="exampleCheck1" value="Lounge">
                              <label>Lounge</label>
                           </div>
                           <div class="mb-3 form-check custom-checkbox-made">
                              <input type="radio" class="form-check-input" name="license_sub_type" id="exampleCheck1" value="Theatre / Venue">
